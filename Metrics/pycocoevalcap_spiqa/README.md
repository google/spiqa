## Uses modified Coco-caption evals to run evals on SPIQA


Modified evals from coco-captions.

(1) Follow instructions below to download the pycocoevalcap library.
```
pip install pycocoevalcap
```

(2) We disabled the computation of SPICE metric in this work.
