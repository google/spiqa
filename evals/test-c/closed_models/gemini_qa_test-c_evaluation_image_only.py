...
def prepare_inputs(paper, question_idx):
  ...
  return answer, all_figures_bytes, referred_figures_indices, all_figures_modified, referred_figures
    ...
    for paper_id, paper in qasper_data.items():
        ...
        try:
          for question_idx, question in enumerate(paper['question']):
              ...
              time.sleep(10)
              answer, all_figures_bytes, referred_figures_indices, all_figures_modified, referred_figures = prepare_inputs(paper, question_idx)
