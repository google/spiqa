...
def prepare_inputs(paper, question_idx):
  ...
  return answer, all_figures_encoded, all_figures_captions, referred_figures_indices, all_figures_modified, referred_figures, full_text
    ...
    for paper_id, paper in qasper_data.items():
        ...
        try:
          for question_idx, question in enumerate(paper['question']):
              ...
              answer, all_figures_encoded, all_figures_captions, referred_figures_indices, all_figures_modified, referred_figures, full_text = prepare_inputs(paper, question_idx)
