...
def infer_internlmxc(qasper_data, args):

    if args.image_resolution == 224:
        _QASPER_IMAGE_ROOT = "../../../datasets/test-C/SPIQA_testC_Images_224px"
    else:
        ...
        try:
            for question_idx, question in enumerate(paper['question']):
                ...
                for _idx, figure in enumerate(referred_figures):
                    ...
                    image = os.path.join(_QASPER_IMAGE_ROOT, paper['arxiv_id'], figure)
...
if __name__ == '__main__':
    ...
    infer_internlmxc(qasper_data, args)
